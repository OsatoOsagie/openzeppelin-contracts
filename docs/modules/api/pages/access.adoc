...
:xref-AccessControlDefaultAdminRules-defaultAdminTransferDelayedUntil--: xref:access.adoc#AccessControlDefaultAdminRules-defaultAdminTransferDelayedUntil--
...
:xref-AccessControl-getRoleAdmin-bytes32-: xref:access.adoc#AccessControl-getRoleAdmin-bytes32-
:xref-AccessControl-_setupRole-bytes32-address-: xref:access.adoc#AccessControl-_setupRole-bytes32-address-
:xref-IAccessControlDefaultAdminRules-DefaultAdminRoleChangeStarted-address-uint48-: xref:access.adoc#IAccessControlDefaultAdminRules-DefaultAdminRoleChangeStarted-address-uint48-
:xref-IAccessControl-RoleAdminChanged-bytes32-bytes32-bytes32-: xref:access.adoc#IAccessControl-RoleAdminChanged-bytes32-bytes32-bytes32-
:xref-IAccessControl-RoleGranted-bytes32-address-address-: xref:access.adoc#IAccessControl-RoleGranted-bytes32-address-address-
:xref-IAccessControl-RoleRevoked-bytes32-address-address-: xref:access.adoc#IAccessControl-RoleRevoked-bytes32-address-address-
...
:defaultAdminTransferDelayedUntil: pass:normal[xref:#AccessControlDefaultAdminRules-defaultAdminTransferDelayedUntil--[`++defaultAdminTransferDelayedUntil++`]]
...
.Functions
--
* {xref-AccessControlDefaultAdminRules-constructor-uint48-address-}[`++constructor(defaultAdminDelay_, initialDefaultAdmin)++`]
...
* {xref-AccessControlDefaultAdminRules-defaultAdminTransferDelayedUntil--}[`++defaultAdminTransferDelayedUntil()++`]
...
[.contract-subindex-inherited]
.IAccessControlDefaultAdminRules
* {xref-IAccessControlDefaultAdminRules-DefaultAdminRoleChangeStarted-address-uint48-}[`++DefaultAdminRoleChangeStarted(newDefaultAdmin, defaultAdminTransferDelayedUntil)++`]
...
==== `[.contract-item-name]#++constructor++#++(uint48 defaultAdminDelay_, address initialDefaultAdmin)++` [.item-kind]#internal#

Sets the initial values for {defaultAdminDelay} in seconds and {defaultAdmin}.
...
Returns the delay between each `DEFAULT_ADMIN_ROLE` transfer.
...
==== `[.contract-item-name]#++pendingDefaultAdmin++#++() → address++` [.item-kind]#public#

Returns the address of the pending `DEFAULT_ADMIN_ROLE` holder.

[.contract-item]
[[AccessControlDefaultAdminRules-defaultAdminTransferDelayedUntil--]]
==== `[.contract-item-name]#++defaultAdminTransferDelayedUntil++#++() → uint48++` [.item-kind]#public#

Returns the timestamp after which the pending default admin can claim the `DEFAULT_ADMIN_ROLE`.
...
Starts a `DEFAULT_ADMIN_ROLE` transfer by setting a pending default admin
and a timer to pass.
...
Completes a `DEFAULT_ADMIN_ROLE` transfer.
...
Cancels a `DEFAULT_ADMIN_ROLE` transfer.
