...
:xref-Governor-_proposalProposer-uint256-: xref:governance.adoc#Governor-_proposalProposer-uint256-
...
Delay, between the vote start and vote ends. The unit this duration is expressed in depends on the clock
...
:_proposalProposer: pass:normal[xref:#Governor-_proposalProposer-uint256-[`++_proposalProposer++`]]
...
* {xref-Governor-_proposalProposer-uint256-}[`++_proposalProposer(proposalId)++`]
...
[.contract-item]
[[Governor-_proposalProposer-uint256-]]
==== `[.contract-item-name]#++_proposalProposer++#++(uint256 proposalId) → address++` [.item-kind]#internal#
